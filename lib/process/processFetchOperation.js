...
function fetchWithKeys(resource, path, key) {
    ...
    if (path.length === 0) {
        const keyValueResource = (0, ensureKeyValue_1.default)(resource);
    ...
    const keyValueParent = (0, ensureKeyValue_1.default)(parent);
...
function fetchWithoutKey(resource, path) {
    ...
    return (_a = (0, ensureKeyValue_1.default)(parent)[currentKey]) !== null && _a !== void 0 ? _a : null;
}
